             ...
             ignoreCase:(BOOL)ignoreCase
{
    ...
    else if (textField.autocompleteType == HTAutocompleteTypeTreatmentUnits)
    {
        static dispatch_once_t treatmentUnitOnceToken;
        static NSArray *treatmentUnitAutocompleteArray;
        dispatch_once(&treatmentUnitOnceToken, ^
        {
            treatmentUnitAutocompleteArray = [[FDLocalizationManager sharedManager] localizedArrayForPath:@"treatment_units"];
        });
        ...
        for (NSString *stringFromReference in treatmentUnitAutocompleteArray)
        {
            NSString *stringToCompare;
            if (ignoreCase)
            {
